...
def backup_development(retention_days: int = 30):
    """
    Crea backup database sviluppo.
    ...
    if not env.db_path.exists():
        print(f"❌ Database sviluppo non trovato: {env.db_path}")
        return False
...
if __name__ == "__main__":
    print("="*60)
    print("BACKUP DATABASE SVILUPPO")
    print("="*60)
    print()
    
    backup_development(retention_days=30)